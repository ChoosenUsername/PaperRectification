...
canvas = image.imread('result.jpg')

start_image = imread("result.jpg")
res = start_image
...
vertical = np.load('npy/cross_vertical_ar.npy', allow_pickle = True)
horizontal = np.load('npy/cross_horizontal_ar.npy', allow_pickle=True)
...
x_coordinate_on_horizontal_line = dict()
...
for line in vertical:
    ...
    x_coordinate_on_horizontal_line[counter] = x1
    #x_coordinate_on_horizontal_line.append([x1, counter])
    counter += 1

print(x_coordinate_on_horizontal_line)

x_coordinate_on_horizontal_line = {k: v for k, v in sorted(x_coordinate_on_horizontal_line.items(), key=lambda item: item[1])}
print(x_coordinate_on_horizontal_line)
