...
working_image = imread("/home/pavel/PaperRectification/img/result.jpg")
...
imsave("/home/pavel/PaperRectification/img/binary_ar.jpg", binary)
...
for _, angle, dist in zip(*hough_line_peaks(h, theta, d)):
    ...
    if np.abs(degress) >= 0 and np.abs(degress) < 70:
        plt.axline((x0, y0), slope=np.tan(angle + np.pi/2), linewidth=0.3, color='r')
...
plt.imshow(canvas)
plt.savefig("/home/pavel/PaperRectification/img/all_lines_ar.jpg", dpi = 1500)

with open('/home/pavel/PaperRectification/npy/cross_vertical_ar.npy', 'wb') as f:
            np.save(f,  cross_vertical)

with open('/home/pavel/PaperRectification/npy/cross_horizontal_ar.npy', 'wb') as f:
