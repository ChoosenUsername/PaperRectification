...
start_image = imread("/home/pavel/PaperRectification/img/result.jpg")
...
cross_vertical = np.load('/home/pavel/PaperRectification/npy/cross_vertical_ar.npy', allow_pickle=True)
...
np.save( '/home/pavel/PaperRectification/npy/vertical_debug_lines_ar', debug_lines)
...
canvas = image.imread('/home/pavel/PaperRectification/img/result.jpg')
...
plt.imshow(canvas)
plt.savefig("/home/pavel/PaperRectification/img/vertical_debug_lines_ar.jpg", dpi = 1500)
plt.clf()
...
cross_horizontal = np.load('/home/pavel/PaperRectification/npy/cross_horizontal_ar.npy',allow_pickle=True)
...
np.save( '/home/pavel/PaperRectification/npy/horizontal_debug_lines_ar', debug_lines)
...
plt.imshow(canvas)
plt.savefig("/home/pavel/PaperRectification/img/horizontal_debug_lines_ar.jpg", dpi = 1500)
