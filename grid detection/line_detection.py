...
working_image = imread("img/result.jpg")

canvas = image.imread('img/result.jpg')
...
plt.imshow(canvas)
plt.savefig("img/all_lines_ar.jpg", dpi = 1500)

with open('npy/cross_vertical_ar.npy', 'wb') as f:
            np.save(f,  cross_vertical)

with open('npy/cross_horizontal_ar.npy', 'wb') as f:
